...
_setSystemParameters:     file format elf32-i386
...
int main(int argc, char* argv[])
{
  ...
  39:	56                   	push   %esi
  3a:	53                   	push   %ebx
  3b:	e8 2b 03 00 00       	call   36b <setSystemParameters>
	printf(1, "Parameters are changed\n");
  40:	59                   	pop    %ecx
  41:	5b                   	pop    %ebx
  42:	68 98 07 00 00       	push   $0x798
  47:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 5b4:	eb 1a                	jmp    5d0 <printf+0x1a0>
          s = "(null)";
 5b6:	bb b0 07 00 00       	mov    $0x7b0,%ebx
        while(*s != 0){
