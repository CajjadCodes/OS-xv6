 ...
 601:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 70 0a 00 00    	mov    %edx,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6e7:	73 4f                	jae    738 <malloc+0xa8>
    ...
    if(p == freep)
 6e9:	8b 3d 70 0a 00 00    	mov    0xa70,%edi
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf 74 0a 00 00       	mov    $0xa74,%edi
    base.s.ptr = freep = prevp = &base;
 76f:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 776:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 779:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 77b:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 782:	00 00 00 
    if(p->s.size >= nunits){
