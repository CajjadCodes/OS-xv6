...
_setProcessParameters:     file format elf32-i386
...
int main(int argc, char* argv[])
{
  ...
  35:	59                   	pop    %ecx
  36:	ff 73 10             	pushl  0x10(%ebx)
	arrivalTimeRatio = atoi(argv[3]);
  39:	89 45 e4             	mov    %eax,-0x1c(%ebp)
	executedCycleRatio = atoi(argv[4]);
  3c:	e8 0f 02 00 00       	call   250 <atoi>
  ...
  46:	57                   	push   %edi
  47:	56                   	push   %esi
  48:	e8 26 03 00 00       	call   373 <setProcessParameters>
  ...
  57:	e8 e4 03 00 00       	call   440 <printf>
	exit();
  5c:	e8 62 02 00 00       	call   2c3 <exit>
  61:	66 90                	xchg   %ax,%ax
  63:	66 90                	xchg   %ax,%ax
  65:	66 90                	xchg   %ax,%ax
  67:	66 90                	xchg   %ax,%ax
