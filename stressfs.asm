...
free(void *ap)
{
 ...
 6e1:	a1 58 0b 00 00       	mov    0xb58,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 58 0b 00 00    	mov    %edx,0xb58
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 58 0b 00 00    	mov    %edx,0xb58
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7c7:	73 4f                	jae    818 <malloc+0xa8>
    ...
    if(p == freep)
 7c9:	8b 3d 58 0b 00 00    	mov    0xb58,%edi
 ...
 7f2:	e8 e9 fe ff ff       	call   6e0 <free>
  return freep;
 7f7:	a1 58 0b 00 00       	mov    0xb58,%eax
 ...
 824:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 827:	a3 58 0b 00 00       	mov    %eax,0xb58
}
 ...
 83e:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 840:	c7 05 58 0b 00 00 5c 	movl   $0xb5c,0xb58
 847:	0b 00 00 
    base.s.size = 0;
 84a:	bf 5c 0b 00 00       	mov    $0xb5c,%edi
    base.s.ptr = freep = prevp = &base;
 84f:	c7 05 5c 0b 00 00 5c 	movl   $0xb5c,0xb5c
 856:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 859:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 85b:	c7 05 60 0b 00 00 00 	movl   $0x0,0xb60
 862:	00 00 00 
    if(p->s.size >= nunits){
