...
00000180 <panic>:
{
  ...
  printf(2, "%s\n", s);
     ...
     189:	68 05 14 00 00       	push   $0x1405
     18e:	6a 02                	push   $0x2
     190:	e8 6b 0e 00 00       	call   1000 <printf>
  exit();
...
000001a0 <fork1>:
{
  ...
  return pid;
    ...
    panic("fork");
     ...
     1b5:	68 6b 13 00 00       	push   $0x136b
...
000001c0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1d9:	ff 24 85 20 14 00 00 	jmp    *0x1420(,%eax,4)
    if(ecmd->argv[0] == 0)
    ...
    printf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     1f9:	68 77 13 00 00       	push   $0x1377
     1fe:	6a 02                	push   $0x2
     200:	e8 fb 0d 00 00       	call   1000 <printf>
    break;
    ...
    panic("runcmd");
     ...
     2bd:	68 70 13 00 00       	push   $0x1370
     2c2:	e8 b9 fe ff ff       	call   180 <panic>
      printf(2, "open %s failed\n", rcmd->file);
     2c7:	51                   	push   %ecx
     2c8:	ff 73 08             	pushl  0x8(%ebx)
     2cb:	68 87 13 00 00       	push   $0x1387
     2d0:	6a 02                	push   $0x2
     2d2:	e8 29 0d 00 00       	call   1000 <printf>
      exit();
     2d7:	e8 a7 0b 00 00       	call   e83 <exit>
      panic("pipe");
     2dc:	83 ec 0c             	sub    $0xc,%esp
     2df:	68 97 13 00 00       	push   $0x1397
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     357:	6a 54                	push   $0x54
     359:	e8 02 0f 00 00       	call   1260 <malloc>
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     387:	6a 18                	push   $0x18
     389:	e8 d2 0e 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     3d7:	6a 0c                	push   $0xc
     3d9:	e8 82 0e 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     417:	6a 0c                	push   $0xc
     419:	e8 42 0e 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     457:	6a 08                	push   $0x8
     459:	e8 02 0e 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
     ...
     489:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ad:	50                   	push   %eax
     4ae:	68 58 1a 00 00       	push   $0x1a58
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4fd:	50                   	push   %eax
     4fe:	68 58 1a 00 00       	push   $0x1a58
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     53e:	50                   	push   %eax
     53f:	68 50 1a 00 00       	push   $0x1a50
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     560:	56                   	push   %esi
     561:	68 58 1a 00 00       	push   $0x1a58
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     60d:	50                   	push   %eax
     60e:	68 58 1a 00 00       	push   $0x1a58
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  cmd = malloc(sizeof(*cmd));
     6d2:	e8 89 0b 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  cmd = malloc(sizeof(*cmd));
     731:	e8 2a 0b 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
parseexec(char **ps, char *es)
  ...
  cmd = malloc(sizeof(*cmd));
     7ad:	6a 54                	push   $0x54
     7af:	e8 ac 0a 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     7fe:	68 d1 13 00 00       	push   $0x13d1
     803:	57                   	push   %edi
     804:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     848:	68 c3 13 00 00       	push   $0x13c3
  ...
  return ret;
     ...
     879:	68 bc 13 00 00       	push   $0x13bc
...
00000890 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     89f:	68 d6 13 00 00       	push   $0x13d6
     8a4:	56                   	push   %esi
     8a5:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     8c9:	68 f4 13 00 00       	push   $0x13f4
  cmd = parseline(ps, es);
...
00000920 <parsepipe>:
{
  ...
  if(peek(ps, es, "("))
     92f:	68 d6 13 00 00       	push   $0x13d6
     934:	57                   	push   %edi
     935:	56                   	push   %esi
  ...
  if(peek(ps, es, "|")){
     ...
     950:	68 f6 13 00 00       	push   $0x13f6
     955:	57                   	push   %edi
     956:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     9a5:	e8 b6 08 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
000009e0 <parseline>:
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     a12:	e8 49 08 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
  ...
  while(peek(ps, es, "&")){
     ...
     a3b:	68 f8 13 00 00       	push   $0x13f8
     a40:	57                   	push   %edi
     a41:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     a51:	68 d4 13 00 00       	push   $0x13d4
     a56:	57                   	push   %edi
     a57:	56                   	push   %esi
  ...
  cmd = malloc(sizeof(*cmd));
     a8d:	e8 ce 07 00 00       	call   1260 <malloc>
  memset(cmd, 0, sizeof(*cmd));
...
00000ac0 <parseexec>:
{
  ...
  if(peek(ps, es, "("))
     ...
     ace:	68 d6 13 00 00       	push   $0x13d6
     ad3:	56                   	push   %esi
     ad4:	53                   	push   %ebx
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     b29:	ff 24 85 38 14 00 00 	jmp    *0x1438(,%eax,4)
     ...
     bc5:	8d 7d 08             	lea    0x8(%ebp),%edi
{
  ...
  peek(&s, es, "");
     ...
     be3:	68 86 13 00 00       	push   $0x1386
  cmd = parseline(&s, es);
  ...
  nulterminate(cmd);
    ...
    printf(2, "leftovers: %s\n", s);
     c0e:	52                   	push   %edx
     c0f:	50                   	push   %eax
     c10:	68 fa 13 00 00       	push   $0x13fa
     c15:	6a 02                	push   $0x2
     c17:	e8 e4 03 00 00       	call   1000 <printf>
    panic("syntax");
     c1c:	c7 04 24 bc 13 00 00 	movl   $0x13bc,(%esp)
     ...
     f5c:	89 d1                	mov    %edx,%ecx
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f89:	0f b6 92 58 14 00 00 	movzbl 0x1458(%edx),%edx
  ...
  write(fd, &c, 1);
     ...
     fce:	56                   	push   %esi
     fcf:	57                   	push   %edi
     fd0:	e8 ce fe ff ff       	call   ea3 <write>
  while(--i >= 0)
...
printf(int fd, const char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1011:	0f 84 b8 00 00 00    	je     10cf <printf+0xcf>
  ap = (uint*)(void*)&fmt + 1;
    1017:	8d 45 10             	lea    0x10(%ebp),%eax
    101a:	83 c6 01             	add    $0x1,%esi
  write(fd, &c, 1);
    101d:	8d 7d e7             	lea    -0x19(%ebp),%edi
  state = 0;
    1020:	31 d2                	xor    %edx,%edx
  ap = (uint*)(void*)&fmt + 1;
    1022:	89 45 d0             	mov    %eax,-0x30(%ebp)
    1025:	eb 37                	jmp    105e <printf+0x5e>
    1027:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    102e:	66 90                	xchg   %ax,%ax
    1030:	89 55 d4             	mov    %edx,-0x2c(%ebp)
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
        state = '%';
    1033:	ba 25 00 00 00       	mov    $0x25,%edx
      if(c == '%'){
    1038:	83 f8 25             	cmp    $0x25,%eax
    103b:	74 17                	je     1054 <printf+0x54>
  write(fd, &c, 1);
    ...
    1049:	e8 55 fe ff ff       	call   ea3 <write>
    104e:	8b 55 d4             	mov    -0x2c(%ebp),%edx
      } else {
        putc(fd, c);
    1051:	83 c4 10             	add    $0x10,%esp
  for(i = 0; fmt[i]; i++){
    1054:	0f b6 1e             	movzbl (%esi),%ebx
    1057:	83 c6 01             	add    $0x1,%esi
    105a:	84 db                	test   %bl,%bl
    105c:	74 71                	je     10cf <printf+0xcf>
    c = fmt[i] & 0xff;
    105e:	0f be cb             	movsbl %bl,%ecx
    1061:	0f b6 c3             	movzbl %bl,%eax
    if(state == 0){
    1064:	85 d2                	test   %edx,%edx
    1066:	74 c8                	je     1030 <printf+0x30>
      }
    } else if(state == '%'){
    1068:	83 fa 25             	cmp    $0x25,%edx
    106b:	75 e7                	jne    1054 <printf+0x54>
      if(c == 'd'){
    106d:	83 f8 64             	cmp    $0x64,%eax
    1070:	0f 84 9a 00 00 00    	je     1110 <printf+0x110>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
    1076:	81 e1 f7 00 00 00    	and    $0xf7,%ecx
    107c:	83 f9 70             	cmp    $0x70,%ecx
    107f:	74 5f                	je     10e0 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    1081:	83 f8 73             	cmp    $0x73,%eax
    1084:	0f 84 d6 00 00 00    	je     1160 <printf+0x160>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    108a:	83 f8 63             	cmp    $0x63,%eax
    108d:	0f 84 8d 00 00 00    	je     1120 <printf+0x120>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
    1093:	83 f8 25             	cmp    $0x25,%eax
    1096:	0f 84 b4 00 00 00    	je     1150 <printf+0x150>
  write(fd, &c, 1);
    109c:	83 ec 04             	sub    $0x4,%esp
    109f:	c6 45 e7 25          	movb   $0x25,-0x19(%ebp)
    10a3:	6a 01                	push   $0x1
    10a5:	57                   	push   %edi
    10a6:	ff 75 08             	pushl  0x8(%ebp)
    10a9:	e8 f5 fd ff ff       	call   ea3 <write>
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
        putc(fd, c);
    10ae:	88 5d e7             	mov    %bl,-0x19(%ebp)
  write(fd, &c, 1);
    10b1:	83 c4 0c             	add    $0xc,%esp
    10b4:	6a 01                	push   $0x1
  for(i = 0; fmt[i]; i++){
  ...
  write(fd, &c, 1);
    ...
    10bd:	e8 e1 fd ff ff       	call   ea3 <write>
  for(i = 0; fmt[i]; i++){
    10c2:	0f b6 5e ff          	movzbl -0x1(%esi),%ebx
        putc(fd, c);
  ...
  for(i = 0; fmt[i]; i++){
    10cb:	84 db                	test   %bl,%bl
    10cd:	75 8f                	jne    105e <printf+0x5e>
    }
  }
}
    ...
    10e8:	6a 00                	push   $0x0
    10ea:	8b 5d d0             	mov    -0x30(%ebp),%ebx
    10ed:	8b 45 08             	mov    0x8(%ebp),%eax
    10f0:	8b 13                	mov    (%ebx),%edx
    10f2:	e8 59 fe ff ff       	call   f50 <printint>
        ap++;
    10f7:	89 d8                	mov    %ebx,%eax
  ...
  write(fd, &c, 1);
    ...
    116d:	74 17                	je     1186 <printf+0x186>
        while(*s != 0){
    ...
    1176:	0f 84 d8 fe ff ff    	je     1054 <printf+0x54>
    117c:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    117f:	89 de                	mov    %ebx,%esi
    1181:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1184:	eb 1a                	jmp    11a0 <printf+0x1a0>
          s = "(null)";
    1186:	bb 50 14 00 00       	mov    $0x1450,%ebx
        while(*s != 0){
    118b:	89 75 d4             	mov    %esi,-0x2c(%ebp)
    118e:	b8 28 00 00 00       	mov    $0x28,%eax
  ...
  write(fd, &c, 1);
    11a0:	83 ec 04             	sub    $0x4,%esp
          s++;
    11a3:	83 c6 01             	add    $0x1,%esi
    11a6:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
    11a9:	6a 01                	push   $0x1
    11ab:	57                   	push   %edi
    11ac:	53                   	push   %ebx
    11ad:	e8 f1 fc ff ff       	call   ea3 <write>
        while(*s != 0){
    11b2:	0f b6 06             	movzbl (%esi),%eax
    11b5:	83 c4 10             	add    $0x10,%esp
    11b8:	84 c0                	test   %al,%al
    11ba:	75 e4                	jne    11a0 <printf+0x1a0>
      state = 0;
    11bc:	8b 75 d4             	mov    -0x2c(%ebp),%esi
    11bf:	31 d2                	xor    %edx,%edx
    11c1:	e9 8e fe ff ff       	jmp    1054 <printf+0x54>
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11d1:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
{
  ...
  freep = p;
    ...
    1211:	5b                   	pop    %ebx
  freep = p;
    1212:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
}
    1218:	5e                   	pop    %esi
    1219:	5f                   	pop    %edi
    121a:	5d                   	pop    %ebp
  ...
  freep = p;
    124c:	89 15 c4 1a 00 00    	mov    %edx,0x1ac4
    p->s.size += bp->s.size;
    1252:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
    1255:	8b 43 f8             	mov    -0x8(%ebx),%eax
    1258:	89 02                	mov    %eax,(%edx)
}
    125a:	5b                   	pop    %ebx
    125b:	5e                   	pop    %esi
    125c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    126c:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  ...
  if((prevp = freep) == 0){
    ...
    127d:	0f 84 ad 00 00 00    	je     1330 <malloc+0xd0>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1283:	8b 07                	mov    (%edi),%eax
    if(p->s.size >= nunits){
    1285:	8b 48 04             	mov    0x4(%eax),%ecx
    1288:	39 f1                	cmp    %esi,%ecx
    128a:	73 71                	jae    12fd <malloc+0x9d>
    128c:	81 fe 00 10 00 00    	cmp    $0x1000,%esi
    1292:	bb 00 10 00 00       	mov    $0x1000,%ebx
    1297:	0f 43 de             	cmovae %esi,%ebx
  p = sbrk(nu * sizeof(Header));
    129a:	8d 0c dd 00 00 00 00 	lea    0x0(,%ebx,8),%ecx
    12a1:	89 4d e4             	mov    %ecx,-0x1c(%ebp)
    12a4:	eb 1b                	jmp    12c1 <malloc+0x61>
    12a6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    12ad:	8d 76 00             	lea    0x0(%esi),%esi
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    12b0:	8b 10                	mov    (%eax),%edx
    if(p->s.size >= nunits){
    12b2:	8b 4a 04             	mov    0x4(%edx),%ecx
    12b5:	39 f1                	cmp    %esi,%ecx
    12b7:	73 4f                	jae    1308 <malloc+0xa8>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    12b9:	8b 3d c4 1a 00 00    	mov    0x1ac4,%edi
    12bf:	89 d0                	mov    %edx,%eax
    12c1:	39 c7                	cmp    %eax,%edi
    12c3:	75 eb                	jne    12b0 <malloc+0x50>
  p = sbrk(nu * sizeof(Header));
    12c5:	83 ec 0c             	sub    $0xc,%esp
    12c8:	ff 75 e4             	pushl  -0x1c(%ebp)
    12cb:	e8 3b fc ff ff       	call   f0b <sbrk>
  if(p == (char*)-1)
    12d0:	83 c4 10             	add    $0x10,%esp
    12d3:	83 f8 ff             	cmp    $0xffffffff,%eax
    12d6:	74 1b                	je     12f3 <malloc+0x93>
  hp->s.size = nu;
    12d8:	89 58 04             	mov    %ebx,0x4(%eax)
  free((void*)(hp + 1));
    12db:	83 ec 0c             	sub    $0xc,%esp
    12de:	83 c0 08             	add    $0x8,%eax
    12e1:	50                   	push   %eax
    12e2:	e8 e9 fe ff ff       	call   11d0 <free>
  return freep;
    12e7:	a1 c4 1a 00 00       	mov    0x1ac4,%eax
      if((p = morecore(nunits)) == 0)
    12ec:	83 c4 10             	add    $0x10,%esp
    12ef:	85 c0                	test   %eax,%eax
    12f1:	75 bd                	jne    12b0 <malloc+0x50>
        return 0;
  }
}
    12f3:	8d 65 f4             	lea    -0xc(%ebp),%esp
        return 0;
    ...
    1301:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      if(p->s.size == nunits)
    1308:	39 ce                	cmp    %ecx,%esi
    130a:	74 54                	je     1360 <malloc+0x100>
        p->s.size -= nunits;
    130c:	29 f1                	sub    %esi,%ecx
    130e:	89 4a 04             	mov    %ecx,0x4(%edx)
        p += p->s.size;
    1311:	8d 14 ca             	lea    (%edx,%ecx,8),%edx
        p->s.size = nunits;
    1314:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
    1317:	a3 c4 1a 00 00       	mov    %eax,0x1ac4
}
    131c:	8d 65 f4             	lea    -0xc(%ebp),%esp
      return (void*)(p + 1);
    131f:	8d 42 08             	lea    0x8(%edx),%eax
}
    1322:	5b                   	pop    %ebx
    1323:	5e                   	pop    %esi
    1324:	5f                   	pop    %edi
    ...
    base.s.ptr = freep = prevp = &base;
    1330:	c7 05 c4 1a 00 00 c8 	movl   $0x1ac8,0x1ac4
    1337:	1a 00 00 
    base.s.size = 0;
    133a:	bf c8 1a 00 00       	mov    $0x1ac8,%edi
    base.s.ptr = freep = prevp = &base;
    133f:	c7 05 c8 1a 00 00 c8 	movl   $0x1ac8,0x1ac8
    1346:	1a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1349:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
    134b:	c7 05 cc 1a 00 00 00 	movl   $0x0,0x1acc
    1352:	00 00 00 
    if(p->s.size >= nunits){
    1355:	e9 32 ff ff ff       	jmp    128c <malloc+0x2c>
    135a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        prevp->s.ptr = p->s.ptr;
    1360:	8b 0a                	mov    (%edx),%ecx
    1362:	89 08                	mov    %ecx,(%eax)
    1364:	eb b1                	jmp    1317 <malloc+0xb7>
