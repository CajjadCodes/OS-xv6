...
00000200 <exitiputtest>:
{
  ...
  printf(stdout, "exitiput test ok\n");
     ...
     285:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     2a0:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "fork failed\n");
     ...
     2b7:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    exit();
     ...
     2ce:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     2e5:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
00000300 <openiputtest>:
{
  ...
  printf(stdout, "openiput test\n");
     ...
     30b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  if(pid == 0){
    ...
    if(fd >= 0){
     ...
     356:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "openiput test ok\n");
     ...
     39a:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "fork failed\n");
     ...
     3bc:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "mkdir oidir failed\n");
     ...
     3d3:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "unlink failed\n");
     ...
     3ea:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
00000400 <opentest>:
{
  ...
  printf(stdout, "open test\n");
     ...
     40b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "open test ok\n");
     ...
     451:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "open echo failed!\n");
     ...
     468:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "open doesnotexist succeeded!\n");
     ...
     47f:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
00000490 <writetest>:
{
  ...
  printf(stdout, "small file test\n");
     ...
     49d:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  for(i = 0; i < 100; i++){
    ...
    printf(stdout, "creat small succeeded; ok\n");
     ...
     4d0:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "writes ok\n");
     ...
     528:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  if(fd >= 0){
    ...
    printf(stdout, "open small succeeded ok\n");
     ...
     55e:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  if(i == 2000){
    ...
    printf(stdout, "read succeeded ok\n");
     ...
     592:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "small file test ok\n");
     ...
     5c0:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     5de:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     5f7:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "error: open small failed!\n");
     ...
     60e:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "read failed\n");
     ...
     625:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "unlink small failed\n");
     ...
     63c:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "error: creat small failed!\n");
     ...
     653:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
00000670 <writetest1>:
{
  ...
  printf(stdout, "big files test\n");
     ...
     67d:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "big files ok\n");
     ...
     775:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     793:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     7aa:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     7c3:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     7de:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "error: open big failed!\n");
     ...
     7f5:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "error: creat big failed!\n");
     ...
     80c:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "unlink big failed\n");
     ...
     823:	ff 35 4c 5e 00 00    	pushl  0x5e4c
     ...
     844:	bb 30 00 00 00       	mov    $0x30,%ebx
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
     ...
     851:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
     ...
     8d6:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
000008f0 <dirtest>:
{
  ...
  printf(stdout, "mkdir test\n");
     ...
     8fb:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "mkdir test ok\n");
     ...
     961:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "mkdir failed\n");
     ...
     978:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "unlink dir0 failed\n");
     ...
     98f:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "chdir .. failed\n");
     ...
     9a6:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    printf(stdout, "chdir dir0 failed\n");
     ...
     9bd:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
000009d0 <exectest>:
{
  ...
  printf(stdout, "exec test\n");
     ...
     9db:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  if(exec("echo", echoargv) < 0){
    ...
    printf(stdout, "exec echo failed\n");
     ...
     a07:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    1226:	31 db                	xor    %ebx,%ebx
{
  ...
  printf(1, "createdelete ok\n");
    ...
    1344:	50                   	push   %eax
    1345:	57                   	push   %edi
    1346:	68 54 4f 00 00       	push   $0x4f54
    134b:	6a 01                	push   $0x1
    ...
    13f8:	57                   	push   %edi
    13f9:	68 30 4f 00 00       	push   $0x4f30
    13fe:	6a 01                	push   $0x1
    ...
    2d45:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "sbrk test\n");
    ...
    2d50:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  *lastaddr = 99;
  ...
  printf(stdout, "sbrk test OK\n");
    ...
    2fba:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    303e:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3059:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3073:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    308b:	50                   	push   %eax
    308c:	53                   	push   %ebx
    308d:	68 fc 53 00 00       	push   $0x53fc
    3092:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    30a2:	56                   	push   %esi
    30a3:	56                   	push   %esi
    30a4:	68 2c 53 00 00       	push   $0x532c
    30a9:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    30c0:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    30d0:	51                   	push   %ecx
    30d1:	51                   	push   %ecx
    30d2:	68 cc 53 00 00       	push   $0x53cc
    30d7:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    30ee:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    311d:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    312d:	56                   	push   %esi
    312e:	53                   	push   %ebx
    312f:	68 a4 53 00 00       	push   $0x53a4
    3134:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3144:	50                   	push   %eax
    3145:	53                   	push   %ebx
    3146:	68 6c 53 00 00       	push   $0x536c
    314b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3162:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3194:	31 f6                	xor    %esi,%esi
{
  ...
  printf(stdout, "validate test\n");
    ...
    319f:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "validate ok\n");
    ...
    3209:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    322b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
00003240 <bsstest>:
{
  ...
  printf(stdout, "bss test\n");
    ...
    324b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
  ...
  printf(stdout, "bss test ok\n");
    ...
    327b:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3293:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
000032b0 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    3310:	c7 04 85 a0 a5 00 00 	movl   $0x5420,0xa5a0(,%eax,4)
    3317:	20 54 00 00 
    ...
    332a:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    args[MAXARG-1] = 0;
    ...
    3357:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    3387:	ff 35 4c 5e 00 00    	pushl  0x5e4c
    ...
    339e:	ff 35 4c 5e 00 00    	pushl  0x5e4c
...
printf(int fd, const char *fmt, ...)
{
  ...
  write(fd, &c, 1);
    ...
    3bd4:	eb 1a                	jmp    3bf0 <printf+0x1a0>
          s = "(null)";
    3bd6:	bb 4e 55 00 00       	mov    $0x554e,%ebx
        while(*s != 0){
