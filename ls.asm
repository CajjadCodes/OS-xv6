...
printf(int fd, const char *fmt, ...)
{
 ...
 759:	e8 55 fe ff ff       	call   5b3 <write>
 ...
 7b9:	e8 f5 fd ff ff       	call   5b3 <write>
        putc(fd, c);
      } else {
 ...
 7cd:	e8 e1 fd ff ff       	call   5b3 <write>
  for(i = 0; fmt[i]; i++){
 ...
 841:	88 45 e7             	mov    %al,-0x19(%ebp)
  write(fd, &c, 1);
 844:	e8 6a fd ff ff       	call   5b3 <write>
        ap++;
 ...
 8bb:	57                   	push   %edi
 8bc:	53                   	push   %ebx
 8bd:	e8 f1 fc ff ff       	call   5b3 <write>
        while(*s != 0){
 ...
 8e1:	a1 08 0e 00 00       	mov    0xe08,%eax
{
 ...
 921:	5b                   	pop    %ebx
  freep = p;
 922:	89 15 08 0e 00 00    	mov    %edx,0xe08
}
 928:	5e                   	pop    %esi
 929:	5f                   	pop    %edi
 92a:	5d                   	pop    %ebp
 ...
 959:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 95c:	89 15 08 0e 00 00    	mov    %edx,0xe08
    p->s.size += bp->s.size;
 962:	89 42 04             	mov    %eax,0x4(%edx)
    p->s.ptr = bp->s.ptr;
 965:	8b 43 f8             	mov    -0x8(%ebx),%eax
 968:	89 02                	mov    %eax,(%edx)
}
 96a:	5b                   	pop    %ebx
 96b:	5e                   	pop    %esi
 96c:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 9db:	e8 3b fc ff ff       	call   61b <sbrk>
  if(p == (char*)-1)
